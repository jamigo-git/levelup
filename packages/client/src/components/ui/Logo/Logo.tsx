export const Logo = ({ fillColor, size }: { fillColor: string; size: string }) => {
  return (
    <div style={{ display: 'flex' }}>
      <svg version='1.0' xmlns='http://www.w3.org/2000/svg' width={size} height={size} viewBox='0 0 163 133'>
        <path
